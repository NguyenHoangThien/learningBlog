        ...
        <div class="row">
            <div class="col-md-4 col-sm-4">
                <div class="footer-widget">
                    ...
                    <div class="single-wid-post">
                        <a href="single-post.html">
                            <img src="/user/img/post-thumb-6.jpg" alt="" class="alignleft">
                    ...
                    <div class="single-wid-post">
                        <a href="single-post.html">
                            <img src="/user/img/post-thumb-7.jpg" alt="" class="alignleft">
            ...
            <div class="col-md-6 col-md-offset-3 text-center">
                <div class="footer-menu">
                    <ul>
                        ...
                        <li><a href="/user/about-me.html">About</a></li>
                        <li><a href="/user/archive.html">Archives</a></li>
                        <li><a href="/user/contact-me.html">Contact me</a></li>
                    </ul>
                </div>
...
<script src="/user/js/vendor/jquery.1.11.1.js"></script>

<script src="/user/js/bootstrap.min.js"></script>
<script src="/user/js/jquery.sticky.js"></script>
<script src="/user/js/owl.carousel.min.js"></script>
<!-- a<script src="js/jquery.tweet.min.js"></script> -->
