...
<!-- Mirrored from demos.wpexpand.com/html/dinilipi/single-post.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Aug 2015 08:54:49 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="author-meta">
                        <div class="row">
                            <div class="col-xs-2">
                                <img src="img/avater.jpg" alt="Farhan Rizvi">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3 col-xs-6">
                                    <a href="single-post.html">
                                        <img class="img-responsive" src="img/rel-post-single.jpg" alt="">
                                        <h2>The Light of future</h2>
                                    </a>
                                </div>
                                <div class="col-sm-3 col-xs-6">
                                    <a href="single-post.html">
                                        <img class="img-responsive" src="img/rel-post-single-1.jpg" alt="">
                                        <h2>We Are Still Alive</h2>
                                    </a>
                                </div>
                                <div class="col-sm-3 col-xs-6">
                                    <a href="single-post.html">
                                        <img class="img-responsive" src="img/rel-post-single-2.jpg" alt="">
                                        <h2>Top secrets to be a great photographer</h2>
                                    </a>
                                </div>
                                <div class="col-sm-3 col-xs-6">
                                    <a href="single-post.html">
                                        <img class="img-responsive" src="img/rel-post-single-4.jpg" alt="">
...
<!-- Mirrored from demos.wpexpand.com/html/dinilipi/single-post.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Aug 2015 08:55:01 GMT -->
</html>