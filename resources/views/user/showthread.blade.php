    ...
    <div class="col-sm-8">
        <article class="post">
            <div class="entry-thumbnail">
                <a title="Behind Story of Some Amazing Photos" class="post-lightbox" href="img/single-post-4.jpg"><img src="/user/img/single-post-4.jpg" alt="Behind Story of Some Amazing Photos"></a>
            </div>   
                ...
                <div class="row">
                    <div class="col-sm-3 col-xs-6">
                        <a href="single-post.html">
                            <img class="img-responsive" src="/user/img/rel-post-single.jpg" alt="">
                            <h2>The Light of future</h2>
                        </a>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                        <a href="single-post.html">
                            <img class="img-responsive" src="/user/img/rel-post-single-1.jpg" alt="">
                            <h2>We Are Still Alive</h2>
                        </a>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                        <a href="single-post.html">
                            <img class="img-responsive" src="/user/img/rel-post-single-2.jpg" alt="">
                            <h2>Top secrets to be a great photographer</h2>
                        </a>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                        <a href="single-post.html">
                            <img class="img-responsive" src="/user/img/rel-post-single-4.jpg" alt="">
        ...
        <div id="comments" class="comments-area">
            ...
            <ol class="comment-list">
                <li class="comment even thread-even depth-1">
                    <article class="comment-body">
                        <div class="comment-author-img">
                            <img src="/user/img/avatar_1.jpg" alt="">
                        </div>
                ...
                <li class="comment even thread-even depth-1">
                    <article class="comment-body">
                        <div class="comment-author-img">
                            <img src="/user/img/avatar_2.jpg" alt="">
                        </div>
                    ...
                    <ul class="children">
                        <li class="comment even thread-even depth-1">
                            <article class="comment-body">
                                <div class="comment-author-img">
                                    <img src="/user/img/avatar_3.jpg" alt="">
                                </div>
                ...
                <li class="comment even thread-even depth-1">
                    <article class="comment-body">
                        <div class="comment-author-img">
                            <img src="/user/img/avatar_4.jpg" alt="">
                        </div>
